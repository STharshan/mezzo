...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-b from-black to-green-900 text-white px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Logo */}
          <img
            className="font-serif tracking-widest ml-8 sm:ml-5"
            src="/logo.png"
            alt="logo"
          />
