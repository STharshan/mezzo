  ...
  return (
    <footer className="bg-gradient-to-b from-black via-green-950 to-green-800 text-white px-6 py-15">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-left">
        {/* Column 1 */}
        <div>
          <h2 className="text-2xl font-bold text-[#4a821d] mb-5">MEZZO</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-md text-gray-400 font-semibold">
            ...
            <li className="flex items-center gap-2">
              <FiPhone className="text-[#4a821d]"/> 01332 318181
            </li>
            <li className="flex items-center gap-2">
              <FiMail className="text-[#4a821d]" /> mezzo.derby@gmail.com
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center text-md text-white font-semibold">
        © 2024 MEZZO. All rights reserved. Made with <span className="text-red-500">❤️</span> for authentic food lovers.
      </div>
    </footer>
  );
};
